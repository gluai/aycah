            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white font-medium text-center drop-shadow-lg"
                      style={{
                        transform: `translateX(${textTranslateX}vw)`,
                        textShadow: "1px 1px 4px rgba(0,0,0,0.8)",
                      }}
              ...
              >
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-white drop-shadow-2xl transition-none"
                  style={{
                    transform: `translateX(-${textTranslateX}vw)`,
                ...
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white drop-shadow-2xl transition-none"
                  style={{
                    transform: `translateX(${textTranslateX}vw)`,
                    textShadow: "2px 2px 8px rgba(0,0,0,0.8), 0 0 20px rgba(0,0,0,0.5)",
                  }}
